...
class TestLambda(unittest.TestCase):
    ...
    def test_lambda_handler_public_subnet_with_cname_and_zone_tags(
            self,
            instance_info,
            hosted_zones,
        ...
        assert response[1] == 'Created CNAME record in zone id: Z2705FFK9RBG8N for hosted zone machine1.ue1.high.test.com. with value: ec2-35-173-186-242.compute-1.amazonaws.com'
