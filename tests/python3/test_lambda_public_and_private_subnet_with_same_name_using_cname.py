...
class TestLambda(unittest.TestCase):
    ...
    def test_lambda_handler_public_and_private_subnet_with_same_name_with_cname_and_zone_tags(
            self,
            instance_info,
            hosted_zones,
                    ...
                    'Instances': [
                        {
                            ...
                            'PrivateDnsName': 'ip-172-31-90-228.ue1.high.test.com',
                            'PrivateIpAddress': '172.31.90.228',
                            'PublicDnsName': 'ec2-35-173-186-242.compute-1.amazonaws.com',
                            'PublicIpAddress': '35.173.186.242',
                            ...
                            'Tags': [
                                {
                                    'Key': 'CNAME',
                                    'Value': 'machine1.ue1.high.test.com.'
                                }
                            ]
                        },
                    ],
        ...
        assert response[1] ==  'Created CNAME record in zone id: Z2705FFK9RBG8O for hosted zone machine1.ue1.high.test.com. with value: ip-172-31-90-228.ue1.high.test.com'
        assert response[2] ==  'Created CNAME record in zone id: Z2705FFK9RBG8N for hosted zone machine1.ue1.high.test.com. with value: ec2-35-173-186-242.compute-1.amazonaws.com'
        mock.stop()
