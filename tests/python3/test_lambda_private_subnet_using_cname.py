...
class TestLambda(unittest.TestCase):
    ...
    def test_lambda_handler_private_subnet_with_cname_and_zone_tags(
        ...
        assert response[1] == 'Created CNAME record in zone id: Z2705FFK9RBG8N for hosted zone machine1.ue1.high.test.com. with value: ip-172-31-90-228.ue1.high.test.com'
        assert response[2] == 'Created A record in zone id: Z2705FFK9RBG8N for hosted zone machine1.ue1.high.test.com. with value: 172.31.90.228'
        assert response[3] == 'Created PTR record in zone id: Z2705FFK9RBG8O for hosted zone 228.90.31.172.in-addr.arpa with value: machine1.ue1.high.test.com.'
